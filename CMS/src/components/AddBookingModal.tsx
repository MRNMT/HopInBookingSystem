...
export const AddBookingModal = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">

      <div className="bg-white w-[500px] rounded-lg shadow-xl p-6 animate-fadeIn">

        <h1 className="text-2xl font-bold text-gray-800 mb-2">Add New Boooking</h1>
        <p className="text-gray-500 mb-6">
          Create a new booking in your hotel . Fill in all the details below.
        </p>

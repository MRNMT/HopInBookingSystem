  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      ...
      <div className="bg-white w-[500px] rounded-lg shadow-xl p-6 animate-fadeIn">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Add New Room</h1>
        <p className="text-gray-500 mb-6">
          Create a new room in your hotel inventory. Fill in all the details below.
        </p>

        <form className="space-y-4">
          <div>
            <label className="font-semibold">Room Picture</label>
            <input className="w-full border p-2 rounded mt-1" type="file" />
          </div>
          ...
          <div>
            ...
            <select id="status" className="w-full border p-2 rounded mt-1">
